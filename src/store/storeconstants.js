// Constante pour définir la mutation de l'authentification.
...
// Constante pour définir le getter pour obtenir le nom.
export const GET_NAME = '[getters] get name';

// Constante pour définir la mutation pour définir le nom d'utilisateur.
